    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("128", new ShipInfoDto("伊8", "潜水艦"));
            ...
            this.put("137", new ShipInfoDto("阿賀野", "軽巡洋艦"));
            this.put("138", new ShipInfoDto("能代", "軽巡洋艦"));
            ...
            this.put("143", new ShipInfoDto("武蔵", "戦艦"));
            ...
            this.put("148", new ShipInfoDto("武蔵改", "戦艦"));
            this.put("149", new ShipInfoDto("金剛改二", "戦艦"));
            ...
            this.put("191", new ShipInfoDto("伊19", "潜水艦"));
            ...
            this.put("305", new ShipInfoDto("阿賀改", "軽巡洋艦"));
            this.put("306", new ShipInfoDto("能代改", "軽巡洋艦"));
            ...
            this.put("400", new ShipInfoDto("伊8改", "潜水空母"));
            this.put("401", new ShipInfoDto("伊19改", "潜水空母"));
