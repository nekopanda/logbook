    ...
    private static final Map<String, ShipInfoDto> SHIP = new ConcurrentHashMap<String, ShipInfoDto>() {
        {
            ...
            this.put("210", new ShipInfoDto("比叡改", "戦艦", "ひえい", 0, 120, 90));
            ...
            this.put("217", new ShipInfoDto("木曾改", "軽巡洋艦", "きそ", 0, 30, 25));
            ...
            this.put("262", new ShipInfoDto("古鷹改", "重巡洋艦", "ふるたか", 0, 60, 35));
            this.put("263", new ShipInfoDto("加古改", "重巡洋艦", "かこ", 0, 60, 35));
            this.put("264", new ShipInfoDto("青葉改", "重巡洋艦", "あおば", 0, 60, 35));
            this.put("265", new ShipInfoDto("妙高改", "重巡洋艦", "みょうこう", 0, 80, 40));
            this.put("266", new ShipInfoDto("那智改", "重巡洋艦", "なち", 0, 80, 40));
            this.put("267", new ShipInfoDto("足柄改", "重巡洋艦", "あしがら", 0, 80, 40));
            this.put("268", new ShipInfoDto("羽黒改", "重巡洋艦", "はぐろ", 0, 80, 40));
            this.put("269", new ShipInfoDto("高雄改", "重巡洋艦", "たかお", 0, 80, 40));
            this.put("270", new ShipInfoDto("愛宕改", "重巡洋艦", "あたご", 0, 80, 40));
            this.put("271", new ShipInfoDto("摩耶改", "重巡洋艦", "まや", 0, 80, 40));
            this.put("272", new ShipInfoDto("鳥海改", "重巡洋艦", "ちょうかい", 0, 80, 40));
            this.put("273", new ShipInfoDto("利根改", "重巡洋艦", "とね", 0, 70, 45));
            this.put("274", new ShipInfoDto("筑摩改", "重巡洋艦", "ちくま", 0, 70, 45));
